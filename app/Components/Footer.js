        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-8 gap-y-12 relative z-10 items-start">
          ...
          <div className="min-w-0 space-y-4 lg:col-span-2">
            ...
            <div className="flex items-center gap-2 pt-2">
              {/* Facebook */}
              <a href="#" className="w-7 h-7 bg-white text-[#031738] rounded-sm flex items-center justify-center hover:opacity-90 transition-opacity">
              ...
              {/* Google */}
              <a href="#" className="w-7 h-7 bg-white text-[#031738] rounded-sm flex items-center justify-center font-bold text-xs hover:opacity-90 transition-opacity">
                G
              </a>
            </div>
