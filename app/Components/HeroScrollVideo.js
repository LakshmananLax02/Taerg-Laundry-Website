...
const stages = [
  {
    eyebrow: 'Campus Laundry Partnership',
    audience: 'Schools • Colleges • Universities',
    title: 'Laundry Infrastructure Built for Modern Campuses.',
    description:
      'Give students dependable laundry access while your institution gains a professionally managed facility designed around campus routines.',
    outcomes: ['Managed end to end', 'Built for institutions'],
    actions: true,
  },
  {
    eyebrow: 'Student Health & Experience',
    audience: 'For Students',
    title: 'Cleaner Clothes. Healthier Campus Life.',
    description:
      'Consistent washing standards, hygienic garment care and convenient access create a better everyday residential experience.',
    outcomes: ['Hygienic care', 'Student convenience'],
  },
  {
    eyebrow: 'Managed Campus Operations',
    audience: 'For Management',
    title: 'Less Administration. Clearer Control.',
    description:
      'Taerg manages staffing, commercial machines, maintenance and service delivery—reducing operational burden for campus teams.',
    outcomes: ['Reliable operations', 'Reduced overhead'],
  },
  {
    eyebrow: 'Shared Campus Value',
    audience: 'Students + Institutions',
    title: 'A Service Students Trust and Institutions Value.',
    description:
      'On-time return, professional care and accountable service strengthen student satisfaction and the institution’s campus offering.',
    outcomes: ['On-time delivery', 'Stronger campus value'],
  },
];
...
export default function HeroScrollSequence() {
  ...
  return (
    <section
      ...
      aria-label="The Taerg campus laundry journey"
    >
      <p className="sr-only">
        Follow a complete Taerg campus laundry journey from professional washing and drying to
        careful folding and convenient delivery back to the student.
      </p>
